...
namespace ConsoleApplication5
{
    class Program
    {
        ...
        {
            // input
            string[] file_input = File.ReadAllLines(@"C:\Users\coloi\Рабочий стол\ConsoleApplication5\input.txt");
            ...
            StreamWriter writer = File.CreateText(@"C:\Users\coloi\Рабочий стол\ConsoleApplication5\output1.txt");
            for (int i = 0; i < file_input.Length; i++)
            {
                string[] temp = new string[result.GetLength(1)];
                for (int j = 0; j < result.GetLength(1); j++)
            ...
            writer = File.CreateText(@"C:\Users\coloi\Рабочий стол\ConsoleApplication5\output2.txt");
            for (int i = 0; i < file_input.Length; i++)
            {
                string[] temp = new string[result.GetLength(1)];
                for (int j = 0; j < result.GetLength(1); j++)
            ...
            writer = File.CreateText(@"C:\Users\coloi\Рабочий стол\ConsoleApplication5\output3.txt");
            for (int i = 0; i < result.GetLength(0) - 1; i++)
            {
